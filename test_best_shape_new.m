...
opts.save_numerical_results = 1;
opts.save_graphics_results = 1;
opts.path.saving_folder = "/loadable_results/convexity-NoTNoS-L1GradSparse/small-initial-guess/";
opts.path.loading_folder = "/loadable_results/with-scaling/small-initial-guess/";
opts.path.loading_folder = "/loadable_results/convexity-NoTNoS/small-initial-guess/";
checkDirectory(opts.path.current_path + opts.path.saving_folder, 1);
